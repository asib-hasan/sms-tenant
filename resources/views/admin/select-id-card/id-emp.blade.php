                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header p-0 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('select-id-card/student') }}" role="tab">Student</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" id="custom-tabs-four-profile-tab" data-toggle="pill" href="#custom-tabs-four-profile" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false">Employee</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-pane fade show active">
                                <div class="container mt-5">
                                    <form action="{{ route('select-id-card/employee/update')}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4 mb-4">
                                                <div class="card card_1 @if($value==1) selected @endif" onclick="selectImage('card_1')">
                                                    <img src="{{ asset('id_card_sample/e1.png') }}" alt="Front Part of ID Card" class="card-img">
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-4">
                                                <div class="card card_2 @if($value==2) selected  @endif" onclick="selectImage('card_2')">
                                                    <img src="{{ asset('id_card_sample/e2.png') }}" alt="Front Part of ID Card" class="card-img">
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-4">
                                                <div class="card card_3 @if($value==3) selected  @endif" onclick="selectImage('card_3')">
                                                    <img src="{{ asset('id_card_sample/e3.png') }}" alt="Front Part of ID Card" class="card-img">
                                                </div>
                                            </div>
                                        </div>
