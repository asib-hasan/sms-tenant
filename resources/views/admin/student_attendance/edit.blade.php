    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 style="font-weight: bold">Attendance Edit : <span class="text-maroon">{{ $date }}</span></h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive p-2 table-bordered">
                            <form class="form-prevent" action="{{ route('atmgt/student/entry/update') }}" method="POST">
                                ...
                                <input type="hidden" name="previous_date" value="{{ Helper::encrypt_decrypt('encrypt',$date) }}">
                                @csrf
                                <table class="table table-hover text-nowrap" id="dataTable">
                                    ...
                                    <tr>
                                        <td colspan="6" class="font-weight-bold">
                                            Select Date
                                            <input type="date" style="border: 1px solid #ddd;border-radius: 5px;padding: 2px" name="date" value="{{ $date }}" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="width: 5%">#</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="status[{{ $i->student_id }}]" style="border: 1px solid #ddd;border-radius: 5px;padding: 2px">
                                                    <option value="P" @selected(isset($status[$i->student_id]) && $status[$i->student_id] == 'P')>Present</option>
                                                    <option value="A" @selected(!isset($status[$i->student_id]) || $status[$i->student_id] == 'A')>Absent</option>
                                                </select>
                                            </td>
                                            <td>{{ $i->student_id }}</td>
