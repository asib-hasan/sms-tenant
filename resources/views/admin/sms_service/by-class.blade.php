    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            ...
                            <div class="card-body">
                                <div class="tab-pane fade show active">
                                  <div class="container">
                                      <form action="{{ route('send-sms/by/class') }}" method="get">
                                        @csrf
                                        <div class="row mt-0 pt-0">
                                            ...
                                            <div class="col-md-2 mt-4">
                                                <button class="btn btn-primary mt-2 btn-custom">SEARCH</button>
                                            </div>
                                        </div>
                                      </form>
                                    </div>
                ...
                @if($flag == 1)
                <form action="{{ route('send-sms/class/send') }}" method="POST">
                @csrf
                <div class="row">
                                ...
                                <div class="row">
                                    <table class="table table-bordered table-responsive-lg">
                                        <tbody >
                                            ...
                                            <tr>
                                                <td><input type="checkbox" class="checkbox" name="numbers[]" value="{{ $student->student_info->mobile ?? '' }}"></td>
