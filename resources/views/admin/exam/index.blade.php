                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title font-weight-bold">Add Exam</h4>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form action="{{ route('exam/store') }}" class="form-group" method="POST">
                                            @csrf
                            ...
                            <table class="table table-hover text-nowrap" id="dataTable">
                                <thead style="background-color: #EAEAEA">
                                    <tr>
                                        ...
                                        <th>Updated By</th>
                                        <th>Status</th>
                                        @if (Helper::canAny(auth()->user(), [18, 19]))
                                        <th>Action</th>
                                        @endif
                                    </tr>
                                </thead>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        ...
                                                        @endcan
                                                        @can('exam_delete', 27)
                                                        <a class="dropdown-item" href="{{ route('exam/delete', ['id' => \App\Helpers\Helper::encrypt_decrypt('encrypt',$i->id)]) }}"
                                                    ...
                                                    <div class="modal fade" id="modal-{{ $i->id }}">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title font-weight-bold">Edit exam</h4>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <form action="{{ route('exam/update') }}" class="form-group" method="POST">
                                                                    @csrf
