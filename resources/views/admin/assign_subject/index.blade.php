...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 style="font-weight: bold">Assign Subject</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12 ml-0">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('acmgt/assign/subject') }}" method="GET">
                                        <div class="row">
                                            @csrf
                    ...
                    @if ($flag == 1)
                                ...
                                <div class="card">
                                    <div class="table-responsive p-2">
                                        <table class="table table-bordered text-nowrap">
                                            <tbody>
                                                <tr>
                                                    <td style="background-color:rgb(231, 231, 231)" colspan="4">
                                                        <b>Overview</b></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Class</b> <br>{{ \App\Models\ClassModel::where('id',$class_id)->first()->name }}</td>
                                                    <td><b>Session</b><br>{{ \App\Models\SessionModel::getName($session_id) }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2"><b>Assigned Subject</b><br>{{$total_subject}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('acmgt/assign/subject/update') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <label class="form-control-label text-lg">Select Subject</label>
                                            <select class="duallistbox" name="subjects[]" multiple="multiple" required>
                                                @foreach ($subject_list as $i)
                                                    @php
                                                        $assigned_subject_info = \App\Models\ClassSubjectModel::where('session_id',$session_id)->where('class_id',$class_id)->where('subject_id',$i->id)->exists();
                                                    @endphp
                                                    @if($assigned_subject_info)
                                                        @continue
                                                    @endif
                            ...
                            <div class="table-responsive p-2">
                                <table class="table table-bordered">
                                    <thead style="background-color: #ddd">
                                        <tr>
                                            <th colspan="4" style="background-color: #ddd">Assigned Subject List</th>
                                        </tr>
                                        <tr>
                                            <th style="width: 5%">#</th>
                                    ...
                                    <tbody>
                                    @forelse($assigned_subject_list as $i)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $i->subject_info->name }}</td>
                                            <td>
                                                <form action="{{ route('acmgt/assign/subject/delete', ['id' => Helper::encrypt_decrypt('encrypt', $i->id)]) }}" method="POST">
                                                    @csrf
    ...
    <script>
        ...
        $('#assign-subject').addClass('active');
    </script>
    <script>
