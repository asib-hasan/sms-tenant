...
<head>
    ...
    <title>Fees Collection Summary</title>
    <style>
        body {
...
<main>
    <table style="width: 100%;">
        ...
        <tr>
            <th style="font-size: 12px; padding: 5px;">
                <img src="{{ asset('photos/school_logo_without_bg.png') }}" alt="Logo" style="object-fit: fill; width: 50px; padding-bottom: 10px"/><br>
                {{ $school_info->name }}<br>
                <span style="font-size: 12px">Fees Collection Summary - {{ \App\Models\SessionModel::getName($session_id) }}</span><br>
            </th>
        </tr>
        </thead>
    </table>
    ...
    <table style="width: 100%;border: 1px solid black;border-collapse: collapse">
        ...
        <tr>
            ...
            <th class="table-th-width-30" style="border: 1px solid black;padding: 4px;text-align: left;width: 50%;">{{ $total_collection }}</th>
        </tr>
        @endforeach
        <tr>
