                            ...
                            <div class="card card-primary card-outline card-outline-tabs">
                                <div class="card-header p-0 border-bottom-0">
                                    <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="{{ route('stdacc/waiver/student') }}">By Student</a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="card-body">
                                    <div class="tab-pane fade show active">
                                        <div class="container">
                                            <form action="{{ route('stdacc/waiver/student') }}" method="GET">
                                                @csrf
                    ...
                    <div class="col-md-12 ml-0">
                        <div class="card">
                            <div class="card-header">
                                <h5 style="font-weight: bold"> Waiver Information<a style="font-size: 15px;float: right" target="_blank" href="{{ route('stdacc/dues/student?student_id=' . $student_reg_info->student_id . '&session_id='. $session_id) }}"><i class="fa fa-eye"></i> View Details</a></h5>
                            </div>
                            <div class="card-body pt-0">
                                <form class="form-prevent" action="{{ route('stdacc/waiver/apply/student') }}" method="POST">
                                    @csrf
                                    ...
                                    <select class="form-control" name="session_id" disabled>
                                        <option value="">Select</option>
                                        @foreach ($session_list as $i)
                                            <option value="{{ $i->id }}" @selected($i->id == $session_id)>{{ $i->name }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control" name="months[]" multiple required>
